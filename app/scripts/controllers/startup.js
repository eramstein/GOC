...
angular.module('gocApp')
  .controller('StartupCtrl', function ($scope, Data, Dataload, ChartsManager, FiltersManager) {
    ...
    //testData = [{'ConstructionYear': '2010-01-05', 'Surface': '100', 'Price': '200000', 'District': 'Orangerie', 'Taxes': '500', 'Garden': '0', 'Category': 'Appartment', 'Item': 'App1'}];
